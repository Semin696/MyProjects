...
& $gpp -std=c++17 -O2 -municode -mwindows -specs=no-default-manifest -static -static-libgcc -static-libstdc++ `
    "main.cpp" "wood.cpp" "intro.cpp" "controls.cpp" "image.cpp" "app.res" -o "PhotoToBW.exe" `
